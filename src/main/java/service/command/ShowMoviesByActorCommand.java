...
public class ShowMoviesByActorCommand implements MenuCommand {
    ...
    public void execute(MovieService movieService, InputHandler inputHandler) {
        var firstName = inputHandler.promptForValidString(LocalizedMessages.PROMPT_ACTOR_FIRST_NAME);
        var lastName = inputHandler.promptForValidString(LocalizedMessages.PROMPT_ACTOR_LAST_NAME);
